...
Los fondos y gradientes permiten construir profundidad y separar regiones sin depender siempre de imágenes externas. Al generarse con CSS, se adaptan al tamaño del elemento y pueden modificarse mediante variables, estados o preferencias de tema.
...
`:root` almacena los colores de la interfaz como propiedades personalizadas. Las reglas posteriores los recuperan con `var()`, de modo que un cambio en la paleta se realiza en un único lugar.
