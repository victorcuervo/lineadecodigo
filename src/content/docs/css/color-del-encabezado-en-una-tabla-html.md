...
description: "Manejo de selectores CSS para poder definir el color del encabezado en una tabla HTML"
date: 2015-07-13
updatedDate: 2026-01-17
tags: ["CSS Tabla","HTML Tabla","HTML Tabla TH","HTML Tabla Thead","css","table","td","color","background-color","first-child","CSS Selector"]
slug: css/color-del-encabezado-en-una-tabla-html
