---
title: "Iterar una lista en Python con índices"
description: "Aprende a iterar una lista en Python con índices y muestra su contenido en consola de manera sencilla y efectiva. ¡Domina este concepto esencial hoy mismo!"
date: 2015-11-18
updatedDate: 2026-01-17
tags: ["range","len","lista","for-each","bucles"]
...
```python
mujeres = ["Sofía", "Isabel", "Luisa", "Estela"]
```
...
```python
for x in range(0, len(mujeres)):
    print(mujeres[x])
```


De esta manera ya habremos conseguido iterar una lista en [Python](http://www.manualweb.net/python/) con índices y mostrar el contenido de la misma sobre la consola utilizando la función [`print()`](https://www.w3api.com/Python/print/).
