...
slug: javascript/aplanar-arrays-en-javascript
...
Aunque el método `.flat()` ya está implementado en la mayoría de los navegadores principales puede ser un problema si tienes que mantener alguna compatibilidad de navegadores. En este caso es importante que le eches un ojo a la compatibilidad del método `.flat()` en [Can I Use]([https://caniuse.com/array-flat](https://caniuse.com/array-flat)).
```


![](../../../assets/javascript/images/array-flat.jpg)
