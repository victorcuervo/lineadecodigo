...
tags: ["Javascript Int.ListFormat","Javascript Intl"]
slug: javascript/formatear-listas-en-javascript
...
Ahora vamos a instanciar el objeto [`Intl.ListFormat`]([http://w3api.com/Javascript/Intl/ListFormat/](http://w3api.com/Javascript/Intl/ListFormat/)). Al igual que [el resto de objetos de tipo Intl]([http://lineadecodigo.com/tag/javascript-intl/](http://lineadecodigo.com/tag/javascript-intl/)) tiene dos parámetros.
El primero corresponde al **locale** en un formato etiqueta [representada por un código BCP 47]([http://tools.ietf.org/html/rfc5646](http://tools.ietf.org/html/rfc5646)). Por lo que tendremos una etiqueta con 2 o 4 caracteres si aplicamos el país del estilo *es-ES, en-US, ar-EG*,... o *es, en, ar*,...
