---
title: "Factorial Java bucle for"
...
tags: ["bucles","for"]
slug: java/factorial-java-bucle-for
...
Así lo primero que necesitaremos es definir una variable [Java](https://www.manualweb.net/java/) que vaya a guardar el valor del factorial. Esta variable la inicializamos a 1.
...
Como los cálculos los estamos haciendo sobre número enteros, tenemos que apoyarnos en la clase [`Integer`](https://www.w3api.com/Java/Integer/) y su método [`.toString()`](https://www.w3api.com/Java/Integer/toString/) para poderlos convertirlos a cadenas.
