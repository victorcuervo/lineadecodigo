...
tags: ["mysql","jdbc","connection"]
slug: java/conectar-mysql-con-java
...
De esta manera ya hemos conseguido conectar MySQL con [Java](https://www.manualweb.net/java/).
