...
slug: java/string-con-salto-de-linea-en-java
...
De esta forma ya sabemos cómo podemos crear una cadena o [`String`](https://w3api.com/Java/String/) con salto de línea en [Java](https://www.manualweb.net/java/). Además del carácter de salto de línea `\n`, ¿qué otros caracteres especiales conoces en [Java](https://www.manualweb.net/java/)? Déjanoslo en los comentarios.
