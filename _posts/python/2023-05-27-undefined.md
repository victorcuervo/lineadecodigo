...
excerpt: "Existen dos formas de poder leer ficheros con Python, bien leyendo el contenido entero del fichero o yendo línea a línea."
categories: Python
tags: [python ficheros,python bucles]
image:
  path: /images/
  thumbnail: /images/
comments: true
