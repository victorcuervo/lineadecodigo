...
excerpt: "El elemento footer nos permite crear un pie de página en HTML5 e incluir contenido como el copyright de la página o enlaces a otras páginas."
categories: HTML5
tags: [html5 footer,html5 semántica]
image:
  path: /images/
  thumbnail: /images/
comments: true
