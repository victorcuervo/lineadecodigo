...
excerpt: "Uso del elemento dialog para poder mostrar un formulario en ventana dialogo con HTML5 y cómo recuperar la información introducida."
categories: HTML5
tags: [html5 dialog,html form,html form input,html form label]
image:
  path: /images/
  thumbnail: /images/
comments: true
