...
excerpt: "Uso del evento onwheel y la función scale() para poder crear un sistema que nos permita realizar un zoom en imágenes con el ratón en HTML5."
categories: HTML5
tags: [html imagenes,css imágenes,html eventos]
image:
  path: /images/
  thumbnail: /images/
comments: true
