...
excerpt: "Utilización de la función setTimeout para poder ejecutar cuando pasen X segundos en Javascript un código configurado en nuestra página."
categories: Javascript
tags: [dom window,dom window settimeout]
image:
  path: /images/
  thumbnail: /images/
comments: true
