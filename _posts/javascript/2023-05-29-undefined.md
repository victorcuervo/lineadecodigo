...
excerpt: "Utilización del lenguaje Javascript para validar que el texto introducido es un número. Para ello utilizamos expresiones regulares."
categories: Javascript
tags: [html eventos,html form,html form input,javascript regexp]
image:
  path: /images/
  thumbnail: /images/
comments: true
