...
excerpt: "Cómo utilizar el método preventDefault() para poder evitar el envío de un formulario dentro de la ejecución de nuestra página web."
categories: DOM
tags: [dom eventtarget,dom eventtarget addeventlistener,dom document getelementbyid,dom document,dom event preventdefault,javascript parseint]
image:
  path: /images/
  thumbnail: /images/
comments: true
