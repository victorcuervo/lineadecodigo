...
excerpt: "Uso de las propiedades width y height de css sobre un elemento table para poder definir el alto y ancho de una tabla en html."
categories: CSS
tags: [html tabla,css tabla]
image:
  path: /images/
  thumbnail: /images/
comments: true
