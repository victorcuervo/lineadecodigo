...
excerpt: "Utilización de bucles while anidados para poder comprobar si tenemos números con dígitos iguales en cualquiera de sus posiciones."
categories: Java
tags: [java integer,java string,java bucles,java bucles while]
image:
  path: /images/
  thumbnail: /images/
comments: true
