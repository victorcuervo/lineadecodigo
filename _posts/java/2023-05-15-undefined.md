...
excerpt: "Cómo podemos conocer cuál es el mayor de dos números en Java que le hayamos pedido a un usuario por teclado y compararemos mediante un if."
categories: Java
tags: [javascript básicos,java if,java util scanner]
image:
  path: /images/
  thumbnail: /images/
comments: true
