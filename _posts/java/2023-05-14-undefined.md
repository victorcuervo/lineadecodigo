...
excerpt: "El Bucle for-each en Java nos permite recorrer de una forma sencilla un array o una colección de una misma manera."
categories: Java
tags: [java bucles,java array,java bucles foreach,java collection,java collection list,java collection listiterator]
image:
  path: /images/
  thumbnail: /images/
comments: true
